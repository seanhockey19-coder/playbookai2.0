...
export default function LadderGenerator() {
  ...
  const generateLadder = () => {
    ...
    // Clean & filter props into proper ladder range
    const parsed = propsData
      .map((p) => {
        ...
        // We only want bets with strong likelihood (ladder-safe)
        const validOver =
